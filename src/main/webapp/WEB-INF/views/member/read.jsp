                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<c:url value='/member?action=edit&MEMBER_SEQ=${resultMap.MEMBER_SEQ }' />">
                                    <input type="hidden" name="action" value="edit" />
										...
										<a href="<c:url value='/member?action=delete&MEMBER_SEQ=${resultMap.MEMBER_SEQ }' />">Delete</a>
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
