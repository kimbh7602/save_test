...
function submitFunction(str){
	if(str == 'insert'){
		$("#edit-form").attr("action", "<c:url value='/member?action=insert' />");
		$("#edit-form").submit(function(){
			alert("insert!!");
		});
	}else if(str == 'update'){
		$("#edit-form").attr("action", "<c:url value='/member?action=update' />");
		$("#edit-form").submit(function(){
			alert("update!!");
		});
	}
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id = "edit-form" role="form" method="POST" action="<c:url value='/member?action=insert' />">
	                                    <input type="hidden" name="action" value="read" />
										<div class="form-group">
										    <label for="disabledSelect">MEMBER_SEQ Disabled input </label>
										    <input class="form-control" type="text" name="MEMBER_SEQ" value="${paramMap.MEMBER_SEQ }" readonly>
                                        ...
                                        <button type="submit" class="btn btn-default" onclick="submitFunction('insert')">Insert Button</button>
                                        <button type="submit" class="btn btn-default" onclick="submitFunction('update')">Update Button</button>
