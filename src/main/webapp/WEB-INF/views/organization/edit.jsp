...
<script>
	/* $(function(){
		$("#insert-submit").click(function(){
			$("#edit-form").attr("action", "<c:url value='/organization/insert' />");
		...
		$("#update-submit").click(function(){
			$("#edit-form").attr("action", "<c:url value='/organization/update' />");
			$("#edit-form").submit(function(){
				alert("update!!");
			});
		});
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="edit-form" role="form" method="POST" action="">
                                        ...
                                        <div class="form-group">
										    ...
										    <input class="form-control" type="text" name="PARENT_ORGANIZATION_SEQ" value="">
                                            <p class="help-block">using Parent UUID method with disabled</p>
                                        </div>
                                        <button id="insert-submit" type="submit" class="btn btn-default" value = "insert" onclick = "submitFunction('insert')">Insert Button</button>
                                        <button id="update-submit" type="submit" class="btn btn-default" value = "update" onclick = "submitFunction('update')">Update Button</button>
