                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<c:url value='/organization/edit?ORGANIZATION_SEQ=${resultMap.ORGANIZATION_SEQ }' />">
										...
										<a href="<c:url value='/organization/delete?ORGANIZATION_SEQ=${resultMap.ORGANIZATION_SEQ }' />">Delete</a>
                                    </form>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
